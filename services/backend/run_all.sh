...
FRONTEND_DIR="$REPO_DIR/services/frontend"
...
HISTORY_EVENTS_FILE="${CRYPTO_RUNTIME_DIR:-/tmp/crypto-runtime}/live_events_history.jsonl"
RUNTIME_CONTROL_FILE="${CRYPTO_RUNTIME_DIR:-/tmp/crypto-runtime}/runtime_control.json"
